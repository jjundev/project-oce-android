...
> 근거: `PRD.md`, `docs/design/firestore-schema.md`, `docs/ui, ux/gamification-emphasis.md`, `docs/ui, ux/01-onboarding-first-session.md`, `docs/ui, ux/home-learning-entry.md`, `$grill-yourself` → `$grill-review --deep auto`(Blocker 5 → 전건 해소, 2회 반복 수렴) → `$grill-me`(needs-you 3건 확정) 도출.
