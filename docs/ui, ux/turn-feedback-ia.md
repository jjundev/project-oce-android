...
> 근거: `PRD.md` §8.2~8.3, FR-10·11·15·16 · `docs/ui, ux/dialogue-learning-flow.md` §6~9 · `docs/design/prompts/feedback-slim.md` · `docs/design/prompts/feedback-deep.md` · `docs/design/firestore-schema.md` §saved_cards · 레거시 `archive/android` 분석(`딸깍영어_UIUX_분석_보고서.md`)
