...
- **외부 정본(참고용 · mirror 원본):** `../../ui, ux/dialogue-learning-flow.md`(상태 축)·`accessibility.md`(a11y)·`turn-feedback-ia.md`(시트 IA)·`../../design-system/PROVENANCE.md`. foundations.md가 이들의 빌드필수 부분집합을 mirror하며, 상충 시 정본이 우선한다(foundations §6 동기화).
