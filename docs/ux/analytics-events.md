...
> 근거: `PRD.md` NFR-7(`PRD.md:289`)·NFR-8(`PRD.md:290`)·성공지표(`PRD.md:73,74,78,348`) · `docs/ux/01-onboarding-first-session.md` §9 · `docs/ux/dialogue-learning-flow.md` §13 · `docs/ux/home-learning-entry.md` §10 · `docs/ux/saved-cards.md` §8 · `docs/ux/daily-limit-ux.md` §9 · `docs/design/firestore-schema.md`
