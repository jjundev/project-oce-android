...
class RecordingSessionFunnelAnalytics : SessionFunnelAnalytics {
    ...
    override fun firstSessionStarted(
        sessionId: String,
        topicId: String,
        length: Int,
        difficulty: String,
    ...
    override fun learningSessionStarted(
        sessionId: String,
        topicId: String,
        length: Int,
        level: String,
        ...
        calls +=
            Call(
                ...
                mapOf(
                    ...
                    "input_mode" to inputMode,
                    "writing_score" to writingScore,
                ),
            )
    }

    override fun speakingAnalyzeResult(
        sessionId: String,
        turnIndex: Int,
        result: String,
    ) {
        calls +=
            Call(
                ...
                mapOf("session_id" to sessionId, "turn_index" to turnIndex, "result" to result),
            )
    }

    override fun deepFeedbackOpened(
        sessionId: String,
        turnIndex: Int,
    ) {
    ...
    override fun sessionComplete(
        ...
        calls +=
            Call(
                "session_complete",
                mapOf("session_id" to sessionId, "turn_count" to turnCount, "is_first" to isFirst),
            )
    }

    override fun summaryPartialFailure(
        sessionId: String,
        sectionsFailed: Int,
    ) {
