 ...
 * 소비처: WaveformCanvas(I2)·OneClickSkeleton(C6)·OneClickOfflineBanner(C4)·OceNavHost(F8) 등.
 *
 ...
 * `OneClickSkeleton(reduceMotion = …)`). 정적 대체 동작 검증은 시스템 설정을 토글(WRITE_SECURE_SETTINGS 필요)
 * 하는 대신 `reduceMotion = true` 를 직접 주입해 반증가능하게 한다.
 */
@Composable
