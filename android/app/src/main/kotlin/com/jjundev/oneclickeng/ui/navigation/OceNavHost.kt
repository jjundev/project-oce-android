...
/**
 * 3탭 내비게이션 그래프(F8). 학습(홈)·기록·설정 탭을 전환한다. 세션 루프(주제→생성→대화→요약)는 이 inner
 * NavHost 가 아니라 outer NavHost 의 `homeSessionGraph` 형제가 소유한다(M3-08, 풀스크린) — 홈 CTA/이어하기는
 * [onStartLearning]/[onResume] 람다(outer NavController 배선)로 진입한다.
 *
