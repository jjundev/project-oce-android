...
object TopicCatalog {
    ...
    val ALL: List<Topic> =
        listOf(
            Topic(
                "cafe-order", "☕", OceIcon.LocalCafe, "카페에서 주문하기", TopicGroup.Daily, true,
                "ordering a drink and a snack at a café counter",
            ),
            Topic(
                "weather-smalltalk", "🌤️", OceIcon.PartlyCloudyDay, "날씨로 스몰토크", TopicGroup.Daily, true,
                "making light small talk about today's weather with an acquaintance",
            ),
            Topic(
                "hobby-intro", "🎸", OceIcon.Interests, "취미·자기소개", TopicGroup.Daily, true,
                "introducing yourself and talking about your hobbies to someone new",
            ),
            Topic(
                "restaurant", "🍽️", OceIcon.Restaurant, "레스토랑 주문·예약", TopicGroup.Daily, true,
                "ordering food or booking a table at a restaurant",
            ),
            Topic(
                "refund-exchange", "🛒", OceIcon.ShoppingCart, "환불·교환 요청", TopicGroup.Daily, false,
                "asking a store clerk for a refund or exchange on a purchased item",
            ),
            Topic(
                "airport-immigration", "✈️", OceIcon.Flight, "공항 입국 심사", TopicGroup.Travel, false,
                "answering an officer's questions at airport immigration",
            ),
            Topic(
                "hotel-checkin", "🏨", OceIcon.Hotel, "호텔 체크인", TopicGroup.Travel, true,
                "checking in at a hotel front desk",
            ),
            Topic(
                "taxi", "🚕", OceIcon.LocalTaxi, "택시 목적지 말하기", TopicGroup.Travel, true,
                "telling a taxi driver your destination and giving directions",
            ),
            Topic(
                "asking-directions", "🧭", OceIcon.Directions, "길 묻기", TopicGroup.Travel, false,
                "asking a stranger on the street how to get to a place",
            ),
            Topic(
                "company-intro", "🏢", OceIcon.BusinessCenter, "회사에서 자기소개", TopicGroup.Work, false,
                "introducing yourself to new colleagues on your first day at work",
            ),
            Topic(
                "interview-intro", "💼", OceIcon.Work, "면접에서 자기소개", TopicGroup.Work, false,
                "introducing yourself and answering opening questions in a job interview",
            ),
            Topic(
                "meeting-schedule", "📅", OceIcon.Event, "회의 일정 조율", TopicGroup.Work, false,
                "coordinating a meeting time with a coworker",
            ),
            Topic(
                "hospital-symptoms", "🏥", OceIcon.LocalHospital, "병원에서 증상 설명", TopicGroup.Life, false,
                "describing your symptoms to a doctor at a clinic",
            ),
            Topic(
                "pharmacy", "💊", OceIcon.Medication, "약국에서 약 사기", TopicGroup.Life, false,
                "buying over-the-counter medicine and asking the pharmacist for advice",
            ),
            Topic(
                "bank-account", "🏦", OceIcon.AccountBalance, "은행 계좌 개설", TopicGroup.Life, false,
                "opening a new bank account at a branch",
            ),
            Topic(
                "phone-booking", "📞", OceIcon.Call, "전화로 예약하기", TopicGroup.Life, false,
